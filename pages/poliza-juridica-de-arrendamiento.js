            ...
            <ContainerInformation>
              <div className="section-info">
                <div className="banner-principal">
                  ...
                  <h1>
                    ¡Tu Renta <span>Segura</span>!
                  </h1>
                </div>
                <div className="info-tools">
                  <p>¡Tu inquilino no paga, Nosotros te pagamos!</p>
                  <div className="content-plan-info">
                    <div className="info-check">
                      ...
                      <span>Investigación del Inquilino</span>
                    </div>
                    <div className="info-check">
                      <svg
                        width="17"
                      ...
                      <span>Elaboración de contratos</span>
                    </div>
                    <div className="info-check">
                      <svg
                        width="17"
