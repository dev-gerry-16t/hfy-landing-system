            ...
            <section title="Términos y Condiciones">
              ...
              <div style={{ fontSize: 16 }}>
                ...
                <p>
                  ...
                  S.A. de C.V. con dirección en Porfirio Diaz 32, Insurgentes
                  San Borja, Benito Juárez, 03100, CDMX (referido como
                  "Proveedor de servicios" en adelante) proporciona una
                  plataforma (en lo sucesivo, "www.homify.ai",
                  independientemente del tipo de acceso a través de la web o la
                  aplicación) en app.homify.ai.
                </p>
                <p>
                  Y como un software separado de una webapp, a través del cual
                  los expertos presentan su trabajo a todos, los usuarios
                  ingresan información con el fin de revisión y aprobación para
                  la comercialización de pólizas de arrendamiento y/o otros
                  productos que en su momento se requieran.
                </p>
                <p>
                  Los presentes Requisitos de participación y Condiciones de uso
                  rigen la prestación de los servicios de pólizas de
                  arrendamiento por parte del Proveedor de servicios para los
                ...
                <p>
                  ...
                  Proveedor de Servicios tendrá derecho a rechazar las
                  solicitudes sin dar razones.
                </p>
                <p>
                  ...
                  comercial o su ocupación a través del trabajo por cuenta
                  propia en la realización de comercializar inmuebles para
                  renta.
                </p>
                <p>
                ...
                <p>
                  Durante el proceso de registro, se le pedirá que proporcione
                  un nombre de usuario y una contraseña. El nombre de usuario
                  debe contener el nombre de la persona o empresa interesada en
                  rentar un inmueble o bien ser el dueño de uno con la decisión
                  de prestarlo bajo un contrato de arrendamiento Usted es
                  responsable de asegurarse de que el nombre de usuario no viole
                  los derechos de terceros, en particular los derechos sobre
                  nombres o marcas registradas, y no sea inmoral.
                </p>
                <p>
                  Debe mantener la confidencialidad de los datos de acceso,
                  incluida la contraseña, y no debe hacerlos accesibles a
                ...
                <p>
                  ...
                  autorizados hayan adquirido o vayan a tener conocimiento de
                  sus datos de acceso, se lo notificará de inmediato al
                ...
                <p>
                  ...
                  logra hacerlo, notifíquenos los cambios de datos
                  inmediatamente por correo electrónico al info@homify.ai o al
                  teléfono 5565840419
                </p>
                <p>
                ...
                <p>
                  ...
                  irremediablemente todos y cada uno de los datos generados
                  dentro del alcance de su participación al final de los 30 días
                  naturales posteriores a la entrada en vigor de la terminación
                  y al final de los posibles períodos de provisión de datos
                  legales.
                </p>
                <p>
                  El usuario deberá descargar y asegurar todos y cada uno de los
                  datos almacenados para él en el portal de homify.ai antes de
                  la entrada en vigor de la terminación: en caso de duda, en el
                  momento de dar aviso. El Proveedor de Servicios no estará
                  obligado a compilar un informe de base de datos ni a entregar
                  datos al usuario después de la entrada en vigor de la
                  rescisión.
                </p>
                <p>
                ...
                <p>
                  Homify.ai solo usara los datos personales de los usuarios,
                  para fines de comercio y registro de clientes, homify.ai no
                  compartirá dichos datos con otras empresas o bases de datos,
                  ah no ser que el usuario lo apruebe o solicite.
                </p>
                <p>
                  El usuario elige compartir sus datos con el portal homify.ai
                  y/o apps del proveedor, sin ser obligado y con decisión propia
                  al registrarse en los portales mencionados.
                </p>
                <p>
