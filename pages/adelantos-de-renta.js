        ...
        <Content>
            ...
            <ContainerInformation>
              <div className="section-info">
                <div className="banner-principal">
                  {/* <h2>Póliza Jurídica de Arrendamiento</h2> */}
                  <h1>
                    ¡Recibe tus pagos de renta <br />
                    <span>en un solo dia</span>!
                  </h1>
                </div>
                <div className="info-tools">
                  <p>Obtén tus adelantos de renta</p>
                  <div className="content-plan-info">
                    <div className="info-check">
                      ...
                      <span>Olvídate de los impagos de tus inquilino</span>
                    </div>
                    <div className="info-check">
                      <svg
                        width="17"
                    ...
                    <div className="info-check">
                      ...
                      <span>Financiación fácil y rápido</span>
                    </div>
                    <div className="info-check">
                      <svg
                        width="17"
                      ...
                      <span>Te buscamos inquilino ..</span>
                    </div>
                    {/* <div className="info-check">
                      <svg
                        width="17"
                      ...
                      <span>Recuperación del inmueble</span>
                    </div> */}
                  </div>
          ...
          <ToolsApp left={`-${count * 300}px`}>
            <h1 className="title-section-functionalities">
              ¡<span>Todo lo que necesitas</span> para proteger tu patrimonio!
            </h1>
              ...
              <Fade left>
                <CardFunctions reverse={false}>
                  ...
                  <div className="info-functionality">
                    <h2>
                      <span>Publica</span> tu propiedad
                    </h2>
                    <p>
                      <strong>Publica</strong> tu propiedad en nuestra bolsa
                      inmobiliaria y <strong>recibe</strong> inquilinos.
                    </p>
                  </div>
                </CardFunctions>
              </Fade>
              <Fade right>
                <CardFunctions reverse={true}>
                  <div className="info-functionality">
                    ...
                    <p>
                      Con nuestras <strong>pólizas jurídicas</strong> nosotros{" "}
                      <strong>nos encargamos </strong>
                      de que el pago de tu renta este siempre a tiempo.
                    </p>
                  </div>
                  <img
