        ...
        <ArticleSection>
          <section title="Aviso de privacidad">
            ...
            <div style={{ fontSize: 16 }}>
              <p>
                <strong>“PANDORA BUSINESS GROUP” S.A.P.I. DE C.V.</strong>
              </p>

              <p>
                Por medio del presente, se hace constar{" "}
                <strong>“PANDORA BUSINESS GROUP”</strong>,{" "}
                <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, es responsable de recabar sus datos
                personales, así como del uso que se le dé a los mismos y de su
                protección, siendo su domicilio en Avenida Porfirio Díaz número
                32, Colonia Insurgentes San Borja, Alcaldía Benito Juárez,
                Código Postal,&nbsp; 03100, Ciudad de México.
              </p>
              ...
              <p>
                ...
                <strong>“PANDORA BUSINESS GROUP”</strong>
                <strong>,</strong> <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, de cualquier responsabilidad al respecto.
              </p>
              ...
              <p>
                ...
                <strong>ropando@segurent.mx</strong> quien será el encargado de
              ...
              <p>
                ...
                <strong>, </strong>
                <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, no cederá los datos de los contratantes a
                terceros salvo solicitud previa y consentimiento expreso del
                titular, y en los supuestos contemplados por el artículo{" "}
                <strong>37</strong> de la Ley Federal de Protección de Datos
              ...
              <p>
                ...
                <strong>, </strong>
                <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, le proporcione los Datos Personales
                relacionados con Usted, y que se encuentren en su posesión, de
                conformidad con la Ley.
              </p>

              <p>
                <strong>Rectificación:</strong> Usted podrá solicitar por
                escrito a <strong>“PANDORA BUSINESS GROUP”</strong>
                <strong>, </strong>
                <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, que cualquiera de sus Datos Personales, sean
                corregidos o modificados, según corresponda, de conformidad con
                la Ley.
              </p>
              ...
              <p>
                ...
                escrito a <strong>“PANDORA BUSINESS GROUP”</strong>
                <strong>,</strong> <strong>S.A.P.I. DE C.V</strong>
                <strong>.</strong>, que se cancelen o den de baja sus Datos
                Personales, siempre y cuando exista una causa que justifique
                dicha acción y no tenga Usted obligaciones pendientes de cubrir
              ...
              <p>
                ...
                <strong>“PANDORA BUSINESS GROUP”,</strong>{" "}
                <strong>S.A.P.I. DE C.V.</strong>, y decida no contratar para sí
                ninguno de los servicios que ésta le ofrece, puede hacer uso de
                este derecho, no compartiendo dato alguno.
              </p>
            </div>
          </section>
        </ArticleSection>
