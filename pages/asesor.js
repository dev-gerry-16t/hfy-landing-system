              ...
              isSelectClient.owner === true
                ...
                ? [
                    ...
                    },
                    {
                      ...
                      pText: (
                        <p>
                          Paga con cualquier tarjeta, crédito o débito y
                          domicilia tu renta
                        </p>
                      ),
                    },
                    {
                      ...
                      pText: (
                        <p>
                          Obtén un descuento o financiamiento para tu mudanza
                        </p>
                      ),
                    },
                  ]
              ...
              isSelectClient.owner === true
                ? [
                    {
                      ...
                      label: (
                        <label lang="es">Investigación de inquilinos</label>
                      ),
                      pText: (
                        <p>
                          Validamos e investigamos que sea la mejor opción para
                          tu inmueble.
                        </p>
                      ),
                    },
                    ...
                    },
                    {
                      ...
                      pText: (
                        <p>Comunicación fácil y rápida con tu arrendador</p>
                      ),
                    },
                  ]
                : isSelectClient.tenant === true
                ? [
                    ...
                    },
                    {
                      ...
                      pText: (
                        <p>
                          Paga todos tus servicios o deudas dentro de la app
                        </p>
                      ),
                    },
                    {
